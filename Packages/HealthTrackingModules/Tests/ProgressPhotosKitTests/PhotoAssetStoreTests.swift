...
final class PhotoAssetStoreTests: XCTestCase {
    ...
    func testLoadReturnsMissingOrCorruptFallbackWithoutExposingAPath() async throws {
        ...
        XCTAssertEqual(
            try await store.loadAsset(id: reference.assetID, variant: .thumbnail),
            .missing
        )
...
@MainActor
private final class PhotoImageProcessorFake: PhotoImageProcessing {
...
@MainActor
private final class RecordingPhotoAssetFileSystem: PhotoAssetFileSystem {
