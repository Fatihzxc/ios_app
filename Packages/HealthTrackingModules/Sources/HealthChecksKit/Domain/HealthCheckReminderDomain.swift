...
public struct HealthCheckCompletionMutation: Equatable, Sendable {
    ...
    public let undoToken: HealthCheckCompletionUndoToken
...
public struct HealthCheckCompletionUndoToken: Equatable, Sendable {
    public let original: HealthCheckReminderSnapshot
    public let completedUpdatedAt: Date
    public let successorID: UUID?
    public let successorUpdatedAt: Date?

    public init(
        original: HealthCheckReminderSnapshot,
        completedUpdatedAt: Date,
        successorID: UUID?,
        successorUpdatedAt: Date?
    ) {
        self.original = original
        self.completedUpdatedAt = completedUpdatedAt
        self.successorID = successorID
        self.successorUpdatedAt = successorUpdatedAt
    }
}
