    ...
    static func createAnonymousFile(
        ...
        do {
            return try ReportExportNamespaceAuthority.shared.transaction {
                ...
                var restoredParentBaseline = false
                defer {
                    if !restoredParentBaseline {
                        // The outer catch retains this exact parent/stage FD record
                        // if a synchronous restoration attempt cannot complete.
                        try? setFlags(
